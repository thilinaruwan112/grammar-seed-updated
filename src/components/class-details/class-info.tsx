              ...
              <div>
                ...
                <ul className="space-y-4 text-muted-foreground">
                  ...
                  <li className="flex items-center">
                   ...
                   <li className="flex items-center">
                    <Youtube className="mr-4 h-5 w-5 text-primary flex-shrink-0" />
                    <span>Recordings: {details.recordings}</span>
                  </li>
                   <li className="flex items-center">
                    <Package className="mr-4 h-5 w-5 text-primary flex-shrink-0" />
                    <span>Monthly Study Pack: {details.studyPack}</span>
                  </li>
                </ul>
              </div>
            </div>
